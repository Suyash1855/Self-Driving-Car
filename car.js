class Car {
    constructor(x, y, width, height, controlType, maxSpeed = 6, color = 'blue') {
        ...
        this.carImg.onload = () => {
            ...
            // this.mask = maskCtx.getImageData(0, 0, this.width, this.height);
        }
    }
    ...
    update(borders, traffic) {
        ...
        if (this.sensor) { 
            ...
            const offset = this.sensor.readings.map(reading => reading == null ? 0 : 1 - reading.offset);
